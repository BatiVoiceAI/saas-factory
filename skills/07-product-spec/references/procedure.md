...
```
  ...
  │  · intégrations attendues        │ ├──▶│ 2. Liste features (complète, S1-S8)  │   § Contexte/Scope/Aha/Features
...
1. **Quatre sources, dans l'ordre :**
   ...
   - (d) **Socle « produit complet »** (`completeness-baseline.md`) — injecté **d'office** (S1-S8) : onboarding wizard qui crée l'entité cœur avec défauts intelligents, profil/settings (dont suppression de compte), empty states, emails/notifs brandés, pages légales FR, 404, seed data, **metadata/favicon**. Universel aux 3 types (canal/mode adaptés). Rattachement = `socle complétude`.
...
- (d) Socle → *onboarding*, *profil/settings*, *empty states*, *emails brandés*, *légal FR + 404*, *seed data*, *metadata/favicon*. → injectés d'office, rattachement `socle complétude`.
...
- [ ] Contexte : problème (point de vue cible), persona précis, edge, intégrations, **type de produit** — **tous repris de Phase 1**.
...
- [ ] Socle « produit complet » (S1-S8) présent en **Must**, chaque élément **adapté au type/à la niche**.
...
| **Squelette de features** | Features cœur correctes mais produit creux | Injecter le socle S1-S8 en Must dès l'étape 2 (`completeness-baseline.md`) |
