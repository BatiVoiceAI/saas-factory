...
## Q3 — Le comportement est-il testable, ou vague ? (étape 3)
...
## Q4 — Le « N'inclut pas » borne-t-il vraiment la feature ? (étape 3)
...
## Q5 — Le MVP est-il le plus PETIT qui résout le problème ? (étape 4)
...
## Q6 — Le Won't have est-il nommé, ou implicite ? (étape 4)
