...
| 5 | `05-opportunity` | Synthèse 1→4 + verdict + décision | tous les précédents | `research/opportunity-brief.md` (bloc §Décision en tête = POURQUOI ; ex-`opportunity-summary.md`, fusion §5) (+ `post-mortem.md` si No-Go) | — (overlay maison) | 🚪 **Go / Ajuster / Go-test / No-Go** |
...
à l'étape 05 : poser la porte (state-and-gates.md) → Go | Ajuster | Go-test | No-Go
```
