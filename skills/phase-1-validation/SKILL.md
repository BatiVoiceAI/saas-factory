...
5. **`05-opportunity`** — synthèse 1→4 → `research/opportunity-brief.md` : le détaillé traçable **+** le bloc **§Décision en tête** (le **POURQUOI**, non-tech, auto-suffisant — fusion §5 : plus de `opportunity-summary.md` séparé). **Porte Go / Ajuster / No-Go.**
